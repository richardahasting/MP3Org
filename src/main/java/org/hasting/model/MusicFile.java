...
public class MusicFile {
    ...
    private Integer fingerprintDuration;
    ...
    /**
     * Gets the audio fingerprint for this music file.
     * The fingerprint is a comma-separated string of 32-bit integers generated by Chromaprint.
     *
     * @return the audio fingerprint, or null if not yet generated
     */
    ...
    /**
     * Sets the audio fingerprint for this music file.
     *
     * @param fingerprint the Chromaprint fingerprint as a comma-separated string of integers
     */
    ...
    /**
     * Gets the duration in seconds used to generate the fingerprint.
     *
     * @return the fingerprint duration in seconds, or null if not yet generated
     */
    public Integer getFingerprintDuration() {
        return fingerprintDuration;
    }

    /**
     * Sets the duration in seconds used to generate the fingerprint.
     *
     * @param fingerprintDuration the duration in seconds
     */
    public void setFingerprintDuration(Integer fingerprintDuration) {
        this.fingerprintDuration = fingerprintDuration;
        this.isModified = true;
    }

    /**
     * Checks if this music file has a fingerprint generated.
     *
     * @return true if a fingerprint exists, false otherwise
     */
